// Chapter  10 - Assignment 4, Indirect Sorting Through Pointers #2
...
// the original array unchanged. This version displays the 
// names of the people in descending order.
#include <fstream>
#include "Person.h"
